...
export function RecipeStepCard({ step, ownedPaintIds }: Props) {
  return (
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {step.paints.map((p) => {
                ...
                return (
                  <div
                    key={p.paintId}
                    className="flex items-center gap-2 bg-iron-700/50 border border-iron-600 rounded-lg px-2.5 py-1.5"
